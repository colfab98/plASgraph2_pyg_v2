...
def main():
    ...
    # 4. Call the training engine
    final_model, final_parameters = train_final_model(parameters, data, device, splits, labeled_indices, log_dir)
